...
const data = [
    ...
    { label: 'Lesson 4', value: '4', list: ["目", "罒", "石", "衤", "足", "马", "页", "巾", "米", "车", "八"], eng: ["eye", "eye", "stone", "clothes", "foot", "horse", "leaf", "turban, scarf", "rice", "cart, vehicle", "eight"], pinyin: ["mù", "mù", "shí", "yī", "zú", "mǎ", "yè", "jīn", "mǐ", "chē", "bā"], colloquial: ["目字旁", "四字头", "石字旁", "衣字旁", "足字旁", "马字旁", "页字旁", "巾字旁", "米字旁", "车字旁", "八字旁"], colloquialPinyin: ["", "", "", "", "", "", "", "", "", ""]},
    { label: 'Lesson 5', value: '5', list: ["尸", "寸", "山", "攵", "攴", "彳", "十", "工", "方", "门", "饣"], eng: ["corpse", "thumb, inch", "mountain", "knock, tap", "knock, tap", "(small) step", "ten", "work", "square, raft", "gate", "eat, food"], pinyin: ["shī", "cùn", "shān", "pū", "chí", "shí", "gōng", "fāng", "mén", "shí"], colloquial: ["尸字头", "寸字旁", "山字旁", "反文旁", "旧反文旁", "双人旁", "十字旁", "工字旁", "方字旁", "门字框", "食字旁"], colloquialPinyin:[]},
    
    { label: 'Lesson 6', value: '6', list: ["欠", "儿", "冫", "子", "疒", "隹", "斤", "亠", "王", "白"], eng: ["lack, yawn", "human, legs", "ice", "child, seed", "sickness", "(short-tailed) bird", "axe, pound", "lid", "jade, king", "white"], pinyin: [], colloquial: ["欠字旁", "儿座底", "两点水", "子字旁", "病字旁", "隹字旁", "斤字旁", "点横头", "王字旁", "白字旁"], colloquialPinyin:["", "", "", "", "", "", "", "", "", ""]},
    
    { label: 'Lesson 7', value: '7', list: ["立", "羊", "艮", "冖", "厂", "皿", "礻", "穴", "走", "雨"], eng: ["stand, erect", "sheep", "stopping", "cover", "cliff", "dish", "sign, spirit, show", "cave", "run, walk", "rain"], pinyin: [], colloquial: ["立字旁", "羊字旁", "艮字旁", "秃宝盖", "厂字旁", "皿字底", "示字旁", "穴宝盖", "走字旁", "雨字旁"], colloquialPinyin:[]},
    { label: 'Lesson 8', value: '8', list: ["口", "小", "戈", "几", "舌", "干", "殳", "夕", "止", "牜"], eng: ["enclosure", "small", "halberd, spear", "table", "tongue", "dry", "weapon", "evening, sunset", "stop", "cow"], pinyin: [], colloquial: ["国字框", "小字旁", "戈字旁", "几字旁", "舌字旁", "千字旁", "殳字旁", "夕字旁", "止字旁", "牛字旁"], colloquialPinyin:[]},
    { label: 'Lesson 9', value: '9', list: ["皮", "耳", "辛", "阝", "酉", "青", "鸟", "弓", "厶", "户"], eng: ["skin", "ear", "bitter", "city", "wine", "green/blue", "bird", "bow", "private", "door, house"], pinyin: [], colloquial: ["皮字旁", "耳字旁", "辛字旁", "双耳刀 (右耳道)", "酉字旁", "青字旁", "鸟字旁", "弓字旁", "私字旁", "户字旁"], colloquialPinyin:[]},
    { label: 'Lesson 10', value: '10', list: ["羽", "舟", "里", "匕", "夊", "见", "卩", "𦉪", "士", "勹"], eng: ["feather", "boat", "village, mile", "spoon", "go (slowly)", "see", "seal", "net", "scholar", "embrace, wrap"], pinyin: [], colloquial: ["羽字旁", "舟字旁", "里字旁", "匕字旁", "折文旁", "见字旁", "单耳刀", "四字头", "士字旁", "包字头"], colloquialPinyin:[]},
];
